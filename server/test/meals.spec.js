...
describe('API endpoint /meals', () => {
  ...
  // GET - List all meals
  it('it should return all meals', () => chai.request(app)
    .get('/api/v1/meals')
    .then((res) => {
  ...
  // GET - a meal
  it('it should return a meal by the given id', () => chai.request(app)
    .get('/api/v1/meals/1')
    .then((res) => {
      expect(res).to.have.status(200);
      // expect(res).to.be.json;
  ...
  // POST - Add new meal
  it('it should add new meal', () => chai.request(app)
    .post('/api/v1/meals')
    .send(meal)
    .then((res) => {
  ...
  it('it should update meal/3', () => chai.request(app)
    .put('/api/v1/meals/3')
    .send(meal)
    .then((res) => {
      expect(res).to.have.status(200);
  ...
  it('it should delete meal/3', () => chai.request(app)
